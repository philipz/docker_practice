...
TARGET_DIRS = ("introduction", "basic_concept", "install", "image", "container", "repository", "data_management", "network", "buildx", "compose", "dockerfile", "kubernetes", "kubernetes_setup", "etcd", "cloud", "ecosystem", "observability", "security", "cases_os", "case_devops", "underly", "appendix_command", "appendix_repo", "appendix_resources", "appendix_practice")
